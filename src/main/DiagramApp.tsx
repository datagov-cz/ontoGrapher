...
export default class DiagramApp extends React.Component<DiagramAppProps, DiagramAppState> {
	...
	componentDidMount(): void {
		let timeout = setTimeout(() => {
			console.error(Locale[ProjectSettings.viewLanguage].authenticationTimeout);
	...
	loadWorkspace() {
		...
		if (contextIRI && isURL(contextIRI)) {
			...
			this.handleChangeLoadingStatus(false, Locale[ProjectSettings.viewLanguage].pleaseReload, true, false);
		}
	}
