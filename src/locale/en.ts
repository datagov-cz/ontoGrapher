export const en = {
	...
	"modalNewElemRegexError": "You cannot name a term using special characters.",
	...
	"validationNumber": "#",
	"deletedRelationships": "Some terms or relationships are hidden in Compact view. To see them again, switch to Full view.",
	"validationName": "Label",
	"validationSeverity": "Severity",
	"errorConnectionLost": "Error: connection to workspace lost.",
	"diagramTab": "Diagrams",
	"modalNewElemExistsError": "A term with this label already exists in the vocabulary.",
	...
	"connectionFrom": "from",
	"diagram": "in diagram",
	"modalRemovePackageItemDescription": "Are you sure you want to remove the term?",
	...
	"modalNewElemDescription": "Enter a label for the new term (these cannot be changed later!):",
