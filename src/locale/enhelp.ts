export const enHelp = {
	...
	"cheatSheet": {
		...
		"interactions": {
			...
			"Terms": {
				"Create a new term:": "Right click on canvas",
				"Center canvas on term (if term on canvas):": "Click on the term in the left panel",
				"Show an existing/hidden term:": "Left click and drag term from the left panel onto the canvas",
				"Show multiple existing/hidden terms:": "Select terms from the left panel via checkboxes / Shift + left click and drag onto the canvas",
				"Select/edit/view details of a concept:": "Left click on term in canvas or left panel",
				"Select multiple concepts:": "Ctrl + left click on each term / click and drag with left mouse button",
				"Move a term:": "Left click and drag the term",
				"Move multiple terms:": "Left click and drag one of the selected terms",
				"Hide a term:": "Move mouse onto term on the canvas + left click on crossed out eye",
				"Delete a term:": "Move mouse onto term in the left panel + click ❌"
			},
			"Relations": {
				"Create a relation:": "Move mouse onto term on the canvas + left click on arrow. Click on another term on the canvas and then pick a relation type",
