	...
	"cheatSheet": {
		...
		"interactions": {
			...
			"Terms": {
				...
				"Show multiple existing/hidden terms:": "Ctrl + left click and drag onto the canvas",
				"Select/edit/view details of a concept:": "Left click on term in canvas or left panel",
				"Select multiple concepts:": "Ctrl + left click on each term on the canvas or the left panel / click and drag with left mouse button on the canvas",
