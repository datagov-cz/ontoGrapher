...
} from "./PatternCreationModalExisting";
...
export const PatternCreationModal: React.FC<Props> = (props: Props) => {
  ...
  const [initSubmit, setInitSubmit] = useState<boolean>(false);
  ...
  const submitExisting = (
    ...
    Object.values(elements).forEach((t, i) => {
    ...
    Object.values(connections).forEach((c, i) => {
