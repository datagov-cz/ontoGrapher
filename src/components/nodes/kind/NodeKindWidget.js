...
export interface NodeKindWidgetProps {
    node: NodeKindModel;
    size?: number;
}

export interface NodeKindWidgetState {}

export class NodeKindWidget extends React.Component<NodeKindWidgetProps, NodeKindWidgetState>{
    constructor(props: NodeKindWidgetProps){
        super(props);
        this.state = {};
    }
...
NodeKindWidget.defaultProps = {
    size: 150,
    node: null
};

export var NodeKindWidgetFactory = React.createFactory(NodeKindWidget);