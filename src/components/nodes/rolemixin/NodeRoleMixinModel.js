...
export class NodeRoleMixinModel extends NodeModel {
    constructor(name: string = "New RoleMixin", color: string = "white") {
        super("roleMixin");
        this.name = name;
        this.color = color;
        this.attributes = [];
        this.addPort(new NodeRoleMixinPortModel("left"));
        this.addPort(new NodeRoleMixinPortModel("right"));
        this.addPort(new NodeRoleMixinPortModel("top"));
        this.addPort(new NodeRoleMixinPortModel("bottom"));
    }
