...
export class NodeCategoryModel extends NodeModel {
    constructor(name: string = "New Category", color: string = "white") {
        super("category");
        this.name = name;
        this.color = color;
        this.attributes = [];
        this.addPort(new NodeCategoryPortModel("left"));
        this.addPort(new NodeCategoryPortModel("right"));
        this.addPort(new NodeCategoryPortModel("top"));
        this.addPort(new NodeCategoryPortModel("bottom"));
    }
