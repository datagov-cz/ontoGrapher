				...
				<Form inline>
					<Form.Control size="sm" as="select"
						...
						<option key={""} value={""}>{this.props.readonly ?
							(this.props.content ? Locale[ProjectSettings.viewLanguage].noStereotypeUML : Locale[ProjectSettings.viewLanguage].noStereotypeData) :
							(this.props.content ? Locale[ProjectSettings.viewLanguage].setStereotypeUML : Locale[ProjectSettings.viewLanguage].setStereotypeData)}</option>
