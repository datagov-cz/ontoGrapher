...
type State = {
  ...
  inputDescriptions: LanguageObject;
  inputSource: string;
...
export class DetailElementDescription extends React.Component<Props, State> {
  ...
  render() {
    return (
      <>
        ...
        <h5>{Locale[AppSettings.interfaceLanguage].detailPanelSource}</h5>
        <Form.Control
          type="text"
          size="sm"
        ...
        />
        <h5>{Locale[AppSettings.interfaceLanguage].detailPanelDescription}</h5>
        <Form.Control
          as={"textarea"}
          rows={3}
          size="sm"
        ...
        {AppSettings.representation === Representation.COMPACT &&
          this.props.infoFunction && (
            <IntrinsicTropeControls
              ...
              infoFunction={(trope: string) => this.props.infoFunction!(trope)}
            />
          )}
      </>
    );
