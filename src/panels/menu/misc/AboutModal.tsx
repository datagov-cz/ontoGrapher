						...
						<Tabs id={"changelog-2021"}>
							...
							<Tab title={"January"} eventKey={"january-2021"}>
								...
								<ul>
									...
									<li>Added center view + restore zoom buttons in the View submenu</li>
								</ul>
							</Tab>
						</Tabs>
					</Tab>
					<Tab title={"2020"} eventKey={"2020"}>
						<Tabs id={"changelog-2020"}>
							<Tab title={"December"} eventKey={"December"}>
								...
								<ul>
									...
									<li>Connections section in detail panel also lists connections to given concept, as
										opposed
							...
							<Tab title={"November"} eventKey={"November"}>
								<h6>27.11.</h6>
								<ul>
									<li>Bug fixing and stability improvements (especially in transaction management)
									</li>
									<li>Startup without a workspace is unsupported, interaction is disabled until the
										workspace
										is
										loaded
									</li>
									<li>skos:altLabel support: management is located in the detail panel</li>
									<li>Display label support: the user can choose what pref/altLabel can be displayed
										on the
										canvas
								...
								<ul>
									...
									<li>Elements from the left panel can be multi-selected using shift-click as well
									</li>
								...
								<ul>
									<li>Bug fixing and stability improvements</li>
									<li>Added ability to select multiple concepts in the left screen and visualize them
										at once
										via
								...
								<ul>
									...
									<li>Deletion and modification of the relationship's shape is now available only on
										selection
										of
							...
							<Tab title={"October"} eventKey={"October"}>
								...
								<ul>
									<li>Bug fixing and stability improvements</li>
									<li>Relationship in the new relationship creation dialogue are now optionally
										filtered for
								...
								<ul>
									...
									<ul>
										...
										<li>Indicator is green and static when connected, red and animated when not
											connected
										</li>
									</ul>
									<li>Editing environment now freezes on connection loss or saving error (and
										unfreezes on
									...
									<ul>
										...
										<li>Option is not shown when all related concepts are already on the diagram
										</li>
									</ul>
								</ul>
							</Tab>
							...
							<Tab title={"August"} eventKey={"August"}>
								...
								<ul>
									<li>Bug fixing and stability improvements</li>
									<li>Creating new concepts now has an intermediate step of entering the label in a
										dialogue
										box
									</li>
								</ul>
							...
							<Tab title={"June"} eventKey={"June"}>
								...
								<h6>2.6.</h6>
								<ul>
									<li>Changed representation to FULL OWL (only basic Zs-GoV relationships are shown as
										links;
										others are represented as Relators)
									</li>
									<li>Implemented Generalization link (found in "➡" tab), with different (UML
										consistent)
										design
									</li>
							...
							<Tab title={"April"} eventKey={"April"}>
								...
								<ul>
									...
									<li>Fixed model interpretation not working between read-only and editable
										vocabularies
									</li>
								...
								<ul>
									...
									<li>Packages can now be "default" - newly created elements automatically appear in
										them
									</li>
								...
								<ul>
									...
									<li>Removed "Generate TTL" button; exporting now happens automatically and also on
										change of
										knowledge structure
									</li>
								</ul>
							...
							<Tab title={"March"} eventKey={"March"}><h6>31.3.</h6>
								<ul>
									<li>Fixed element buttons placement issues when renaming an element with links
										attached
									</li>
									<li>Fixed package panel not updating when renaming element prefLabels</li>
									<li>Fixed wrong vocabulary assignment when fetching subclasses of found resources
									</li>
								</ul>
								<h6>30.3.</h6>
								<ul>
									...
									<li>Fixed awkward behaviour of elements when renaming them (more specifically,
										changing
										their shape)
									</li>
								</ul>
								...
								<ul>
									...
									<li>Links created from & to the same element are now assumed as a connection to
										itself; a
								...
								<ul>
									...
									<li>Instead of a central model folder, each model is displayed individually in the
										root
									</li>
								...
								<h6>20.3.</h6>
								<ul>
									<li><b>Changed link creation mechanism:</b> Links are now created by dragging from
										the
										center without any keyboard input. The borders are used for moving the element.
										What
										function gets triggered on click is reflected via change in cursor. <b>Feedback
											is
								...
								<ul>
									...
									<li>Clicking on Save Project... also console.logs the JSON for debugging purposes
									</li>
